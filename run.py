...
from model import HADACL
import utils
from mian import train_one_epoch
...
def get_args_parser():
    ...
    # backbone parameters
    parser.add_argument('--encoder_dim', type=list, nargs='+', default=[[784, 1024, 1024, 1024, 128], [784, 1024, 1024, 1024, 128]])
    ...
    parser.add_argument('--blr', type=float, default=5.0e-4)
    # parser.add_argument('--min_blr', type=float, default=5.0e-4)

    parser.add_argument('--lr', type=float, default=None, metavar='LR',
                        help='learning rate (absolute lr)')

    # data loader and logger
    parser.add_argument('--dataset', type=str, default='YouTubeFace50',
                        choices=['Scene15', 'MNISTUSPS', 'NoisyMNIST', 'YouTubeFace50'])
    parser.add_argument('--missing_rate', type=float, default=0.1)
    parser.add_argument('--data_path', type=str, default='./data/',
                        help='path to your folder of dataset')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--output_dir', type=str, default='./data/txt/',
...
def train_one_time(args, state_logger):
    ...
    model = HADACL(batch_size=args.batch_size,
...
def main(args):
    ...
    # for lr in [1.0e-5, 3.0e-5, 5.0e-5, 8.0e-5, 1.0e-4, 2.0e-4, 3.0e-4, 4.0e-4, 5.0e-4, 8.0e-4, 1.0e-3]:
    #     args.blr = lr
